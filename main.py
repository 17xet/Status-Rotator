...
import json
import os
from pystyle import Col, Colorate
...
banner = """
                            ...
                            └─                                                     ─┘
"""
print(Colorate.Vertical(Col.purple_to_blue, banner, 2))
...
while True:
    ...
    for status in statuses:
        ...
        token_color_code = "32" if is_valid_token else "31"
        ...
        if len(emoji_data) == 2:
            ...
            print(f"{Col.red}Invalid emoji: {emojis[emoji_count % len(emojis)]}")
            continue

        print(f"{time_formatted} {Col.gray}Status changed for: {Col.blue}{token_colored}{Col.gray}. New status: {Col.blue}{status_colored}{Col.reset} | Emoji: {emoji_name}")
